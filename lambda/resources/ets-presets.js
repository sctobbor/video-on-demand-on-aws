...
exports.handler = (event, context, callback) => {
  ...
  if (event.RequestType == "Delete") {
    ...
    var preset_ids = process.env.preset_ids.split(',');
  ...
  if (event.RequestType == "Create") {
    ...
    presets.forEach(function(preset, index) {
        ...
        asyncFunctions[preset.id] = function(callback) {
            ...
            var params = JSON.parse(fs.readFileSync(preset.data, 'utf8'));
    ...
    async.parallel(asyncFunctions,
        ...
        function(err, results) {
            if (err) {
              ...
              var ids = [results.Mp4_1080p,results.Mp4_720p,results.Mp4_540p,results.Mp4_432p,results.Mp4_360p,results.Mp4_270p,results.Mp4_234p,results.Hls_1080p,results.Hls_720p,results.Hls_540p,results.Hls_432p,results.Hls_360p,results.Hls_270p,results.Hls_234p];
